...
basic_output = get_med_effs_binY_binM(0,0,0)

test_that("Output of get_med_effs_binY_binM is named correctly", {
...
some_output = get_med_effs_binY_binM(log(2), log(2), 2)
...
neg_output = get_med_effs_binY_binM(-log(2), -log(2), 2)
